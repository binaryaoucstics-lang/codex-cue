...
namespace CodexOptionPrompts.Ui {
    public partial class PromptWindow : Window {
        ...
        private ToggleButton CreateOptionButton(OptionQuestion question, OptionChoice option, int index) {
            ToggleButton button;
            if (question.Mode == CodexOptionPrompts.Core.SelectionMode.Single) {
            ...
            if (question.Mode == CodexOptionPrompts.Core.SelectionMode.Multiple) button.Unchecked += OnOptionToggled;
            return button;
        }
