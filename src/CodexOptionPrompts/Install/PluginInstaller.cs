...
namespace CodexOptionPrompts.Install {
    public class PluginInstaller {
        private const string ManagedName = "codex-option-prompts";
        ...
        private void InstallCore(InstallRequest request) {
            ...
            try {
                ...
                string marketplace = MarketplaceEditor.Upsert(originalMarketplace, entry);
        ...
        private void InstallProgram(string stagedProgram) {
            ...
            string destination = Path.Combine(paths.ProgramDirectory, "CodexOptionPrompts.exe");
