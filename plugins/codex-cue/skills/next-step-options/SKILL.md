...
description: Use whenever Codex has genuinely completed the user's requested task and is about to finish the turn. Generate 2-3 relevant next-task choices and present them through the codex_cue ask_options MCP tool instead of listing suggestions only in assistant prose.
---
