    ...
    internal static class RequestNormalizerTests {
        public static void Register(TestRegistry tests) {
            ...
            tests.Add("RequestNormalizer legacy none mode suppresses desktop UI", delegate {
                ...
                IDictionary<string, object> payload = CodexOptionPrompts.Ipc.PipeProtocol.RequestPayload(request);
                OptionRequest roundTrip = CodexOptionPrompts.Ipc.PipeProtocol.RequestFromPayload(payload);
